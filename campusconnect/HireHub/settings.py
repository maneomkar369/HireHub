...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-u6-^ea_ma-b4#)4oh^&pnb7f^c#5-)39m)^v%xfk=gg++i)uqh')
...
# Use PostgreSQL on Railway (when DATABASE_URL is set)
...
# For production, configure SMTP (uncomment and set values)
...
# Google OAuth settings (to be set in environment variables)
